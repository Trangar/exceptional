...
/// Automatically generated unit test for Executable
/// Executes some very important action!
/// generated at Wed, 17 Oct 2018 07:36:32 +0000
///
/// exception was "Whoopsie"
#[test]
pub fn test_1539761792338() {
	use exceptional::Executable;
	let obj_json = r#"{
  "var_1": 0,
  "var_2": 1
}"#;
	let mut obj: ::SomeImportantAction = ::serde_json::from_str(obj_json).expect("Could not deserialize json");
